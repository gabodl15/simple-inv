...
if(isset($_POST['submit'])){
    $conexion->drop($_POST['seleccion'], $_POST['drop']);
}
   ...
   <body>
       ...
       <div class="container">
           <div class="formulario">
               <form class="row g-3" action="drop_stock.php" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" value="0" class="form-control" name="drop">
                        </div>
                    </div>
                    <div class="col-auto">
                        <button type="submit" name="submit" class="btn btn-danger mb-3">Eliminar</button>
                    </div>
               </form>
           </div>
       </div>
